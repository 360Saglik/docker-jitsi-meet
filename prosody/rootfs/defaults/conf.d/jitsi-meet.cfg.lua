...
{{ $ENV := .Env -}}
{{ $ENABLE_EVENT_SYNC := .Env.ENABLE_EVENT_SYNC | default "false" | toBool -}}
{{ $EVENT_SYNC_API_PREFIX := .Env.EVENT_SYNC_API_PREFIX | default "" - }}
{{ $EVENT_SYNC_API_TOKEN := .Env.EVENT_SYNC_API_TOKEN | default "" - }}
